...
static struct dtv_cmds_h dtv_cmds[] = {
	...
	[DTV_ATSCMH_PARADE_ID] = {
		.name	= "DTV_ATSCMH_PARADE_ID",
		.cmd	= DTV_ATSCMH_PARADE_ID,
		.set	= 1,
	},
	[DTV_ATSCMH_RS_FRAME_ENSEMBLE] = {
		.name	= "DTV_ATSCMH_RS_FRAME_ENSEMBLE",
		.cmd	= DTV_ATSCMH_RS_FRAME_ENSEMBLE,
		.set	= 1,
	},

	[DTV_ATSCMH_FIC_VER] = {
		.name	= "DTV_ATSCMH_FIC_VER",
		.cmd	= DTV_ATSCMH_FIC_VER,
		.set	= 0,
	},
	[DTV_ATSCMH_PARADE_ID] = {
		.name	= "DTV_ATSCMH_PARADE_ID",
	...
	[DTV_ATSCMH_RS_FRAME_MODE] = {
		.name	= "DTV_ATSCMH_RS_FRAME_MODE",
		.cmd	= DTV_ATSCMH_RS_FRAME_MODE,
		.set	= 0,
	},
	[DTV_ATSCMH_RS_FRAME_ENSEMBLE] = {
		.name	= "DTV_ATSCMH_RS_FRAME_ENSEMBLE",
	...
	[DTV_ATSCMH_RS_CODE_MODE_PRI] = {
		.name	= "DTV_ATSCMH_RS_CODE_MODE_PRI",
		.cmd	= DTV_ATSCMH_RS_CODE_MODE_PRI,
		.set	= 0,
	},
	[DTV_ATSCMH_RS_CODE_MODE_SEC] = {
		.name	= "DTV_ATSCMH_RS_CODE_MODE_SEC",
		.cmd	= DTV_ATSCMH_RS_CODE_MODE_SEC,
		.set	= 0,
	},
	[DTV_ATSCMH_SCCC_BLOCK_MODE] = {
		.name	= "DTV_ATSCMH_SCCC_BLOCK_MODE",
		.cmd	= DTV_ATSCMH_SCCC_BLOCK_MODE,
		.set	= 0,
	},
	[DTV_ATSCMH_SCCC_CODE_MODE_A] = {
		.name	= "DTV_ATSCMH_SCCC_CODE_MODE_A",
		.cmd	= DTV_ATSCMH_SCCC_CODE_MODE_A,
		.set	= 0,
	},
	[DTV_ATSCMH_SCCC_CODE_MODE_B] = {
		.name	= "DTV_ATSCMH_SCCC_CODE_MODE_B",
		.cmd	= DTV_ATSCMH_SCCC_CODE_MODE_B,
		.set	= 0,
	},
	[DTV_ATSCMH_SCCC_CODE_MODE_C] = {
		.name	= "DTV_ATSCMH_SCCC_CODE_MODE_C",
		.cmd	= DTV_ATSCMH_SCCC_CODE_MODE_C,
		.set	= 0,
	},
	[DTV_ATSCMH_SCCC_CODE_MODE_D] = {
		.name	= "DTV_ATSCMH_SCCC_CODE_MODE_D",
		.cmd	= DTV_ATSCMH_SCCC_CODE_MODE_D,
		.set	= 0,
	},
	[DTV_ATSCMH_FIC_ERR] = {
		.name	= "DTV_ATSCMH_FIC_ERR",
		.cmd	= DTV_ATSCMH_FIC_ERR,
		.set	= 0,
	},
	[DTV_ATSCMH_CRC_ERR] = {
		.name	= "DTV_ATSCMH_CRC_ERR",
		.cmd	= DTV_ATSCMH_CRC_ERR,
		.set	= 0,
	},
	[DTV_ATSCMH_RS_ERR] = {
		.name	= "DTV_ATSCMH_RS_ERR",
		.cmd	= DTV_ATSCMH_RS_ERR,
		.set	= 0,
	},
	[DTV_VENDOR_MODEL_NO] = {
		.name	= "DTV_VENDOR_MODEL_NO",
		.cmd	= DTV_VENDOR_MODEL_NO,
		.set	= 0,
	},
	[DTV_VENDOR_I2C_BUS_NO] = {
		.name	= "DTV_VENDOR_I2C_BUS_NO",
		.cmd	= DTV_VENDOR_I2C_BUS_NO,
		.set	= 0,
	},
};
				    ...
				    struct inode *inode, struct file *file)
{
	...
	case DTV_ATSCMH_RS_ERR:
		...
		break;
	case DTV_VENDOR_MODEL_NO:
		tvp->u.data = fe->dtv_property_cache.vendor_model_no;
		break;
	case DTV_VENDOR_I2C_BUS_NO:
		tvp->u.data = fe->dtv_property_cache.vendor_i2c_bus_no;
		break;
