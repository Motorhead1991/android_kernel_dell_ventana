 ...
 * $Id: hnddma.h,v 13.72.4.1.2.1.16.9 2009/11/18 22:29:44 Exp $
 */
...
#define DMAINITFN(_fn) BCMINITFN(_fn)

extern hnddma_t * DMAINITFN(dma_attach)(osl_t *osh, char *name, si_t *sih, void *dmaregstx,
	void *dmaregsrx, uint ntxd, uint nrxd, uint rxbufsize, uint nrxpost,
...
extern uint BCMROMFN(dma_addrwidth)(si_t *sih, void *dmaregs);


extern void BCMROMFN(dma_txpioloopback)(osl_t *osh, dma32regs_t *);

#ifdef DMA_PRERING_ALLOC
extern void dma_prealloc_ring(uint8 num_dmarings);
#endif
